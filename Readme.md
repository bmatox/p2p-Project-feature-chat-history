...
Notamos alguns problemas com essa abordagem: A medida que novos usuários entram na conversa, o identificador do arquivo de texto aumentava consideravelmente           por conta da inserção do nome de novos integrantes no identificador. Caso o usuário converse com um usuário que ele já tenha conversado, o histórico de chat existente será sobreescrevido. Estes problemas foram solucionados utilizando a classe UUID que permite criar um indentificador único composto por 36 caracteres hexadecimais.
